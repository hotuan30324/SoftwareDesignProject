...
namespace BTL
{
    public partial class Form2 : Form
    {
        ...
        private void btnMuaVe_Click(object sender, EventArgs e)
        {
            ...
            frmbv.ShowDialog();
            HienThiDanhSachVeThuong();
            HienThiDanhSachVeThuongGia();
        }
        ...
        private void HienThiDanhSachMB()
        {
            ...
            cbMaMayBay2.DataSource = dt;
            cbMaMayBay2.DisplayMember = "MaMayBay";
            cbMaMayBay2.ValueMember = "MaMayBay";
        ...
        private void hienThiChuyenBayNoiDia()
        {
            DataTable dt = new ChuyenBayNoiDiaCreator().createChuyenBay().hienThiDanhSachChuyenBay();
            dtgvChuyenBayNoiDia.DataSource = dt;
            dtgvChuyenBayNoiDia.MultiSelect = false;
            dtgvChuyenBayNoiDia.MultiSelect = true;
            dtgvChuyenBayNoiDia.Rows[0].Selected = true;
        ...
        private void hienThiChuyenBayQuocTe()
        {
            DataTable dt = new ChuyenBayQuocTeCreator().createChuyenBay().hienThiDanhSachChuyenBay();
            dtgvChuyenBayQuocTe.DataSource = dt;
            dtgvChuyenBayQuocTe.MultiSelect = false;
            dtgvChuyenBayQuocTe.MultiSelect = true;
            dtgvChuyenBayQuocTe.Rows[0].Selected = true;
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            hienThiChuyenBayNoiDia();
            hienThiChuyenBayQuocTe();
        ...
        public void HienThiDanhSachDuongDi()
        {
            ...
            cbMaDuongDi2.DataSource = dt;
            cbMaDuongDi2.DisplayMember = "LoTrinh";
            cbMaDuongDi2.ValueMember = "MaDD";
        ...
        private void btnXoaMB_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                foreach (DataRow rCB in CB.Rows)
                {
                    VeThuongCreator veThuongCreator = new VeThuongCreator();
                    Ve ve = veThuongCreator.createVe();
                    DataTable VeCanXoa = ve.timKiemVeBangMaChuyenBay(rCB["MaChuyenBay"].ToString());
                    if(VeCanXoa.Rows.Count > 0)
                    {
                        bool kq_3 = DAO.ActHoaDon.Instance.XoaHDByMaVe(VeCanXoa.Rows[0]["MaVe"].ToString());
                    }
                    bool kq_2 = ve.xoaVeBangMaChuyenBay(CB.Rows[0]["MaChuyenBay"].ToString());
        ...
        private void xoaChuyenBay_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                DataTable VeCanXoa = new VeThuongCreator().createVe().timKiemVeBangMaChuyenBay(MaCB);

                bool kq_3 = DAO.ActHoaDon.Instance.XoaHDByMaVe(VeCanXoa.Rows[0]["MaVe"].ToString());
                bool kq_2 = new VeThuongCreator().createVe().xoaVeBangMaChuyenBay(MaCB);
        ...
        private void dgvChuyenBayNoiDia_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != null && e.RowIndex >= 0 && e.RowIndex < dtgvChuyenBayNoiDia.Rows.Count - 1)
            {

                DataGridViewRow row = dtgvChuyenBayNoiDia.Rows[e.RowIndex];
                DataRow rowMayBay = this.loadMayBayFromCB(row.Cells[0].Value.ToString()).Rows[0];
        ...
        private void xoaDuongDi_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                foreach(DataRow rCB in CB.Rows)
                {
                    DataTable VeCanXoa = new VeThuongCreator().createVe().timKiemVeBangMaChuyenBay(rCB["MaChuyenBay"].ToString());
                    if (VeCanXoa.Rows.Count > 0)
                    {
                        bool kq_3 = DAO.ActHoaDon.Instance.XoaHDByMaVe(VeCanXoa.Rows[0]["MaVe"].ToString());
                    ...
                    bool kq_2 = new VeThuongCreator().createVe().xoaVeBangMaChuyenBay(CB.Rows[0]["MaChuyenBay"].ToString());
                    bool kq_4 = DAO.ActChuyenBay.Instance.Xoa(CB.Rows[0]["MaChuyenBay"].ToString());
                }
        ...
        {
            ChuyenBay objCB = new ChuyenBayQuocTeCreator().createChuyenBay();

            if (dtpNgayDi2.Value > dtNgayDen2.Value)
            {
                MessageBox.Show("Ngày đi và ngày đến không hợp lệ!");
                return;
            }

            objCB.MaChuyenBay = txbMaChuyenBay2.Text;
            objCB.MaMayBay = cbMaMayBay2.SelectedValue.ToString();
            objCB.MaDD = cbMaDuongDi2.SelectedValue.ToString();
            objCB.Manv = manvf1;
            //objCB.Manv = MANV.Rows[0]["MaNV"].ToString().Trim();
            objCB.NgayDi = dtpNgayDi2.Value;
            objCB.NgayDen = dtNgayDen2.Value;
            objCB.GioDi = dtGioDi2.Text;
            objCB.Ghichu = txbchuyenBayNote2.Text;
        ...
        private void themChuyenBay_Click(object sender, EventArgs e)
        {
            ChuyenBay objCB = new ChuyenBayNoiDiaCreator().createChuyenBay();
        ...
        private void xoaChuyenBay_Click_1(object sender, EventArgs e)
        {
            DialogResult dr = MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            if (dr == DialogResult.Yes)
            {
        ...
        private void dtgvChuyenBayQuocTe_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != null && e.RowIndex >= 0 && e.RowIndex < dtgvChuyenBayQuocTe.Rows.Count - 1)
            {

                DataGridViewRow row = dtgvChuyenBayQuocTe.Rows[e.RowIndex];
                DataRow rowMayBay = this.loadMayBayFromCB(row.Cells[0].Value.ToString()).Rows[0];

                txbMaChuyenBay2.Text = row.Cells[0].Value.ToString();
                dtpNgayDi2.Value = Convert.ToDateTime(row.Cells[1].Value);
                dtNgayDen2.Value = Convert.ToDateTime(row.Cells[2].Value);
                dtGioDi2.Value = Convert.ToDateTime(row.Cells[3].Value);
                txtQlCBLoaiMB2.Text = rowMayBay["TenMayBay"].ToString();
                txtQlCBHangMB2.Text = rowMayBay["HangSanXuat"].ToString();
                txtQlCBSoGheEco2.Text = (Convert.ToInt32(rowMayBay["SoLuongGhe1"].ToString()) + Convert.ToInt32(rowMayBay["SoLuongGhe2"].ToString())).ToString();
                txtQlCBNoiDi2.Text = row.Cells[6].Value.ToString();
                txtQlCBNoiDen2.Text = row.Cells[7].Value.ToString();
                txbchuyenBayNote2.Text = row.Cells[8].Value.ToString();

                cbMaDuongDi2.SelectedIndex = cbMaDuongDi2.FindStringExact(txtQlCBNoiDi2.Text.Trim() + "-" + txtQlCBNoiDen2.Text.Trim());
                //MessageBox.Show(txtQlCBNoiDi.Text.Trim() + "-" + txtQlCBNoiDen.Text.Trim());
            }
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            bool kq = false;
            kq = objCB.capNhatChuyenBay(objCB);
        ...
        private void cbMaDuongDi_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                string MaCB = txbMaChuyenBay2.Text;
